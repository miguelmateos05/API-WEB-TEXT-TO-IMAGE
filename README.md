...
How to use:
1-Download the project, and create a .env with:

    API_TOKEN="INSERT YOUR ACCESS TOKEN FROM HUGGINGFACE"
    PORT=3000

    
2-Install Bun (It is like Node.js) :

    Windows---> powershell -c "irm bun.sh/install.ps1 | iex"
    Linux & macOS---> curl -fsSL https://bun.sh/install | bash
3-In the terminal, we have to install hono (Framework to build Web Applications using Server and Clients)

    > bun install hono
4-Run our API-WEB (Running at http://localhost:3000)
